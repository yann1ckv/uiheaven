 ...
 */
                ...
                function writeMediaSection(transceiver, caps, type, stream, dtlsRole) {
                    ...
                    sdp += SDPUtils.writeDtlsParameters(
                        transceiver.dtlsTransport.getLocalParameters(), type === 'offer'
                        ? 'actpass'
                        : dtlsRole || 'active');
                ...
                module.exports = function(window, edgeVersion) {
                                ...
                                if (!rejected && !transceiver.isDatachannel) {
                                    ...
                                    if (!self.usingBundle || sdpMLineIndex === 0) {
                                        ...
                                        if (iceTransport.state === 'new') {
                                            iceTransport.start(
                                                iceGatherer, remoteIceParameters, isIceLite
                                                ? 'controlling'
                                                : 'controlled');
                                        }
                    ...
                    RTCPeerConnection.prototype.setRemoteDescription = function(description) {
                        ...
                        if (this._dtlsRole === undefined) {
                            this._dtlsRole = description.type === 'offer'
                                ? 'active'
                                : 'passive';
                        }
        ...
        2: [
            function(require, module, exports) {
                ...
                SDPUtils.parseRtpMap = function(line) {
                    ...
                    // was: channels
                    parsed.numChannels = parts.length === 3
                        ? parseInt(parts[2], 10)
                        : 1;
                    return parsed;
                };
                ...
                SDPUtils.writeRtpDescription = function(kind, caps) {
                    ...
                    // Build the mline.
                    sdp += 'm=' + kind + ' ';
                    sdp += caps.codecs.length > 0
                        ? '9'
                        : '0'; // reject if no codecs.
                    ...
                    shimPeerConnection: function(window) {
                        ...
                        window.RTCPeerConnection.prototype.getStats = function(selector, successCallback, errorCallback) {
                            ...
                            if (arguments.length >= 2) {
                                ...
                                return origGetStats.apply(this, [
                                    successCallbackWrapper_, arguments[0]
                                ]);
                            }
 ...
 */
   ...
   */
                    disableWarnings: function(bool) {
                        ...
                        return 'adapter.js deprecation warnings ' + (
                            bool
                            ? 'disabled'
                            : 'enabled');
                    },
